...
export const metadata: Metadata = {
  title: "About",
  description: "About Pickleball Card Games - 1,729 twist cards and a real scorekeeper.",
};
...
export default function AboutPage() {
  return (
    <>
      <h1>About</h1>
      <p className="lede">
        Pickleball Card Games fuses a real side-out scorekeeper with 1,729 twist cards.
      ...
      <p>
        The deck holds exactly 1,729 cards - the Ramanujan taxicab number, the smallest number
