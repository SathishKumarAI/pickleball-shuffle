...
| T11 | 🔴 | **Coach / Umpire match-recording mode** | Planned Phase 2. Top-level choice screen after the welcome tour: *Play with cards* vs *Track a match*. Scorekeeper + optional cards; tracks singles/doubles, server # (1/2) + rotation, side-switch at halfway, timeouts/faults; saves to Match history + exportable match sheet with player/team + event labels. Full design: [`docs/superpowers/specs/2026-06-30-understand-and-play-design.md`](superpowers/specs/2026-06-30-understand-and-play-design.md) (Phase 2). Task breakdown: session tasks #7–#10. |
